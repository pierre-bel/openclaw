...
RUN --mount=type=cache,id=s/a4eae7d3-9d2c-4469-bb36-e5110ed6d459-/root/.local/share/pnpm/store,target=/root/.local/share/pnpm/store,sharing=locked \
...
RUN --mount=type=cache,id=s/a4eae7d3-9d2c-4469-bb36-e5110ed6d459-/var/cache/apt,target=/var/cache/apt,sharing=locked \
    --mount=type=cache,id=s/a4eae7d3-9d2c-4469-bb36-e5110ed6d459-/var/lib/apt,target=/var/lib/apt,sharing=locked \
    apt-get update && \
